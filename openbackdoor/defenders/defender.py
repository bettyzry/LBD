...
class Defender(object):
    ...
    def detect(self, model: Optional[Victim] = None, clean_data: Optional[List] = None,
        ...
        Returns:
            :obj:`List`: the prediction of the poison data.[0:no poison, 1:poison]
        """
    ...
    def eval_detect(self, model: Optional[Victim] = None, clean_data: Optional[List] = None,
                    poison_data: Optional[Dict] = None):
        """
        Evaluate defense.
    ...
    def eval(self, model: Optional[Victim] = None, clean_data: Optional[List] = None,
        ...
        """
        对原始victim的结果进行处理，得到最终的pred_label
        ...
        Returns:
            :obj:`Dict`: evaluate_classification的输出结果
        """
        return {}
