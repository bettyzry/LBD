...
class PLMVictim(Victim):
    ...
    def transfer2Muscle(self, muscleConfig):
        if muscleConfig.get('lora') and muscleConfig.get('loraConfig') is not None:
            loraConfig = LoraConfig(**muscleConfig.get('loraConfig'), task_type=TaskType.SEQ_CLS)
        ...
        if muscleConfig.get('mslr') and muscleConfig.get('mslrConfig') is not None:
    ...
    def transfer2Baseline(self, baselineConfig):
        if baselineConfig.get('adapter') and baselineConfig.get('adapterConfig') is not None:
            print('transfer to baseline adapter')
            adapterConfig = baselineConfig.get('adapterConfig')
        ...
        elif baselineConfig.get('prefix') and baselineConfig.get('prefixConfig') is not None:
            print('transfer to baseline prefix tuning')
            prefixConfig = baselineConfig.get('prefixConfig')
